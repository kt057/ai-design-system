 ...
 */
figma.connect(Input, "https://www.figma.com/design/vMAQsMSeIcoHMumNzKLeaQ/?node-id=5-40", {
  props: {
  ...
  example: ({ isInvalid, isDisabled }) => (
    <Input label="Label" placeholder="Placeholder" isInvalid={isInvalid} isDisabled={isDisabled} />
  ),
});
